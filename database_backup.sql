...
--
-- Name: projects_volunteers; Type: TABLE; Schema: public; Owner: Guest
--

CREATE TABLE public.projects_volunteers (
    project_id integer,
...
ALTER TABLE public.projects_volunteers OWNER TO "Guest";

--
-- Name: projects_volunteers_id_seq; Type: SEQUENCE; Schema: public; Owner: Guest
--

CREATE SEQUENCE public.projects_volunteers_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.projects_volunteers_id_seq OWNER TO "Guest";

--
-- Name: projects_volunteers_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Guest
--

ALTER SEQUENCE public.projects_volunteers_id_seq OWNED BY public.projects_volunteers.id;
...
--
-- Name: projects_volunteers id; Type: DEFAULT; Schema: public; Owner: Guest
--

ALTER TABLE ONLY public.projects_volunteers ALTER COLUMN id SET DEFAULT nextval('public.projects_volunteers_id_seq'::regclass);
...
--
-- Data for Name: projects_volunteers; Type: TABLE DATA; Schema: public; Owner: Guest
--

COPY public.projects_volunteers (project_id, volunteer_id, id) FROM stdin;
\.
...
--
-- Name: projects_volunteers_id_seq; Type: SEQUENCE SET; Schema: public; Owner: Guest
--

SELECT pg_catalog.setval('public.projects_volunteers_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.volunteers_id_seq', 47, true);
...
--
-- Name: projects_volunteers projects_volunteers_pkey; Type: CONSTRAINT; Schema: public; Owner: Guest
--

ALTER TABLE ONLY public.projects_volunteers
